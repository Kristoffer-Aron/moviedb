...
function HighestRatedTvShowsList() {                                      //Bemærk Query-function kaldes automatisk når komponenten bliver displayed
  const {data, error, isFetching } = useFetchHighestRatedTvShowsQuery();  //kaldet vil straks hente data i et result-objekt, som vi "destructure" til data, error og isLoading
